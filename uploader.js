...
// @require     https://raw.githubusercontent.com/coollachlan8/ptp-scripts/main/ffmpegwasm.js
...
// GM_xmlhttpRequest({ method: 'GET', url: "https://unpkg.com/@ffmpeg/ffmpeg@0.12.7/dist/umd/814.ffmpeg.js",
// 								onload: function(response) {
// 									console.log(response)
//                   let ree = new Blob(response.responseText, "text/javascript")
//                   console.log(ree)
// 								},
...
async function getScreenshots(fileEntries) {
    ...
    console.log(ffmpeg)
    await ffmpeg.load( {
          "workerLoadURL": "https://unpkg.com/@ffmpeg/ffmpeg@0.12.7/dist/umd/814.ffmpeg.js"
    })
    // Load
    console.log("loaded")
