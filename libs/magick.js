...
var DYNAMIC_BASE = 6646224,
    DYNAMICTOP_PTR = 1403312;
...
Module["asm"] = function (global, env, providedBuffer) {
    ...
    env["table"] = wasmTable = new WebAssembly.Table({ initial: 5441, maximum: 5441, element: "anyfunc" });
...
var ___tm_current = 1403168;
var ___tm_timezone = (stringToUTF8("GMT", 1403216, 4), 1403216);
...
var asmLibraryArg = {
    ...
    n: invoke_vii,
    ka: invoke_viid,
    ja: invoke_viidddddddd,
    x: invoke_viii,
    k: invoke_viiii,
    K: invoke_viiiii,
    bb: invoke_viiiiii,
    y: invoke_viiiiiiii,
    ia: invoke_viiiiiiiii,
    ab: invoke_viiiiiiiiii,
    db: invoke_vij,
    b: ___assert_fail,
    $a: ___buildEnvironment,
    _a: ___clock_gettime,
    f: ___cxa_allocate_exception,
    Za: ___cxa_pure_virtual,
    g: ___cxa_throw,
    ...
    ya: _clock,
    H: _clock_gettime,
    xa: _emscripten_get_heap_size,
    wa: _emscripten_longjmp,
    ...
    G: _mktime,
    z: _nanosleep,
    pa: _pthread_attr_init,
    oa: _pthread_attr_setdetachstate,
    J: _pthread_cond_destroy,
    Y: _pthread_cond_init,
    D: _pthread_cond_signal,
